    ...
    <section ref={containerRef} className="relative h-screen min-h-[700px] overflow-hidden bg-navy-950">
      ...
      >
        ...
        <div className="overflow-hidden">
          {['CRAFTWORX', 'ARCHITECTURE.'].map((line, i) => (
            <motion.div
              key={line}
              initial={{ y: '110%' }}
              animate={{ y: 0 }}
            ...
            >
              <h1
                ...
                style={{
                  ...
                  fontWeight: line === 'ARCHITECTURE.' ? 700 : 300,
                }}
              >
                {line}
              </h1>
...
function ServiceMarquee() {
  const routes = ['GARDENS', 'PATIOS', 'DRIVEWAYS', 'POOLS', 'RETAINING WALLS', 'WATER FEATURES', 'PERGOLAS', 'DECKING', 'FENCING'];
          ...
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-6">
            <div>
              ...
              <h2 className="font-heading text-white leading-[0.92]" style={{ fontSize: 'clamp(2rem, 4.5vw, 3.5rem)' }}>
                Our <span className="text-emerald-600">Craft</span>
              </h2>
            </div>
            <Link
              to="/services"
    ...
    <section ref={containerRef} className="bg-navy-950 py-24 sm:py-32 lg:py-40 overflow-hidden">
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 mb-12 sm:mb-16">
        ...
        >
          <div>
            <div className="w-12 h-[3px] bg-emerald-600 mb-6" />
            <p className="text-emerald-600/60 text-xs uppercase tracking-[0.3em] mb-3" style={{ fontFamily: 'var(--font-sans)' }}>Portfolio</p>
            <h2 className="font-heading text-white leading-[0.92]" style={{ fontSize: 'clamp(2rem, 5vw, 4rem)' }}>
              Designed to <span className="text-emerald-600">Inspire</span>
            </h2>
          </div>
          <Link
            to="/projects"
...
function WhyChooseUs() {
  ...
  const points = [
    { title: 'Bespoke Garden Design', desc: 'Every garden is unique. We create custom designs that reflect your lifestyle and property character.' },
    { title: 'Sustainable Practices', desc: 'Indigenous plants, water-wise irrigation, and organic soil management for gardens that last.' },
    { title: 'Hardscaping', desc: 'Patios, retaining walls, water features, and pathways crafted with precision stonework.' },
    { title: 'Aftercare Programs', desc: 'Monthly garden maintenance, seasonal planting, and pruning schedules to keep your garden pristine.' },
  ];
